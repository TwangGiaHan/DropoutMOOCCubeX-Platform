  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-500">
        <div className="bg-white border border-slate-200 p-8 rounded-2xl shadow-sm relative overflow-hidden">
            ...
            <h2 className="text-3xl font-extrabold text-slate-900 tracking-tight leading-tight relative Z-10">{data.course?.course_name || courseId}</h2>
            <p className="text-slate-600 mt-2 text-lg font-medium relative Z-10">Detailed metrics for <span className="font-mono text-slate-800 font-bold bg-slate-100 px-2 py-0.5 rounded">{courseId}</span> • {data.course?.school || "Unknown School"}</p>
        </div>
